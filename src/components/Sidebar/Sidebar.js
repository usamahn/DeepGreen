        ...
        return (
            ...
            >
                <header className={s.logo}>
                    <a href="https://demo.flatlogic.com/light-blue-react/">Deep<span
                        className="fw-bold">Green</span></a>
                </header>
                <ul className={s.nav}>
                    <LinksGroup
                        onActiveSidebarItemChange={activeItem => this.props.dispatch(changeActiveSidebarItem(activeItem))}
                        activeItem={this.props.activeItem}
                        header="Gaz Emissions"
                        isHeader
                ...
                <ul className={s.sidebarLabels}>
                    <li>
                        <a href="#">
                            ...
                            <span className={s.labelName}>Optimized</span>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <i className="fa fa-circle text-primary mr-2"/>
                            <span className={s.labelName}>Normal</span>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <i className="fa fa-circle text-danger mr-2"/>
                            <span className={s.labelName}>Wearning</span>
                        </a>
                    </li>
                </ul>
                {/* eslint-enable */}
