...
import MainCharts from '../../pages/components/MainCharts/MainCharts';

import MainChartsTwo from '../../pages/components/MainChartsTwo/MainChartsTwo';
              ...
              <TransitionGroup>
                ...
                >
                  <Switch>
                    ...
                    <Route path="/app/main/dashboard" exact component={MainCharts} />
                    <Route path="/app/main/dashboard2" exact component={MainChartsTwo} />
                    <Route path="/app/main/dashboardtest" exact component={Dashboard} />
                    <Route path="/app/components/icons" exact component={UIIcons} />
                    <Route path="/app/notifications" exact component={UINotifications} />
                    

                    <Route path="/app/components/Maincharts" exact component={MainCharts} />
